...
export default function ConfiguracoesPage() {
  ...
  async function carregarConfiguracoes() {
    try {
      ...
      if (
        ...
        setTelefone(
          perfilEncontrado.phone ||
            ""
        );

        setModoPadrao(
          perfilEncontrado.default_mode ||
            "artist"
        );

        setTema(
          perfilEncontrado.theme ||
            "system"
        );
      }
  ...
  async function salvarPerfil() {
    ...
    if (
      ...
      setErro(
        "Você não possui perfil de Casa para defini-lo como modo padrão."
      );
  ...
  const assinaturaArtista =
    useMemo(
      () =>
        assinaturas.find(
          (assinatura) =>
            assinatura.artist_id ===
              artista?.id &&
            [
              "trialing",
              "active",
      ...
      <div className="mx-auto max-w-6xl space-y-6 px-4 py-7">
        <section className="rounded-3xl border border-zinc-800 bg-gradient-to-br from-zinc-950 via-zinc-950 to-red-950/20 p-6">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            Gerencie sua conta,
            perfis e assinatura da Aura Beat.
          </p>
        </section>
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            ...
            <div>
              ...
              <select
                ...
                onChange={(event) =>
                  setModoPadrao(
                    event.target.value as ModoPerfil
                  )
                }
                className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-3 outline-none focus:border-red-500"
              >
        ...
        <section className="rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {artista ? (
              ...
              <article className="rounded-2xl border border-dashed border-zinc-800 bg-black/20 p-5">
                <p className="font-black">
                  🎧 Perfil de Artista
                </p>

                <p className="mt-2 text-sm text-zinc-500">
                  Você ainda não possui um perfil de Artista.
                </p>
                ...
                <button
                  ...
                  className="mt-4 rounded-xl border border-zinc-700 px-4 py-2 text-sm font-bold"
                >
                  Criar perfil
                </button>
              </article>
            ...
            {casa ? (
              ...
              <article className="rounded-2xl border border-dashed border-zinc-800 bg-black/20 p-5">
                ...
                <p className="mt-2 text-sm text-zinc-500">
                  Você ainda não possui um perfil de Casa.
                </p>
        ...
        <section className="rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
          ...
          <p className="mt-2 text-sm text-zinc-500">
            Artista e Casa possuem assinaturas separadas.
          </p>
              ...
              <article className="rounded-2xl border border-zinc-800 bg-black/30 p-5">
                ...
                assinaturaArtista ? (
                    ...
                    {assinaturaArtista.status ===
                      ...
                      <p className="mt-4 text-sm text-zinc-500">
                        ...
                        <strong className="text-zinc-300">
                          {data(
                            assinaturaArtista.trial_ends_at
                          )}
                        </strong>
                      </p>
                    )}

                    {assinaturaArtista.current_period_end && (
                      <p className="mt-2 text-sm text-zinc-500">
                        Período atual até{" "}
                        <strong className="text-zinc-300">
                          {data(
                  ...
                  <>
                    ...
                    <p className="mt-2 text-sm text-zinc-500">
                      Escolha um plano de Artista quando ativarmos o fluxo de assinatura.
                    </p>
                  </>
                )}
              </article>
              ...
              <article className="rounded-2xl border border-zinc-800 bg-black/30 p-5">
                ...
                assinaturaCasa ? (
                  <>
                    ...
                    {assinaturaCasa.status ===
                      ...
                      <p className="mt-4 text-sm text-zinc-500">
                        ...
                        <strong className="text-zinc-300">
                          {data(
                            assinaturaCasa.trial_ends_at
                          )}
                        </strong>
                      </p>
                    )}

                    {assinaturaCasa.current_period_end && (
                      <p className="mt-2 text-sm text-zinc-500">
                        Período atual até{" "}
                        <strong className="text-zinc-300">
                          {data(
                  ...
                  <>
                    ...
                    <p className="mt-2 text-sm text-zinc-500">
                      Escolha um plano de Casa quando ativarmos o fluxo de assinatura.
                    </p>
                  </>
                )}
              </article>
