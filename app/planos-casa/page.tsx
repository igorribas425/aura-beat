            ...
            {plans.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  {!current && (
                    <div className="mt-5 rounded-xl border border-zinc-800 bg-black/30 p-3 text-xs leading-5 text-zinc-500">
                      A assinatura automática pelo ASAAS será conectada ao fluxo
                      de pagamento. O Admin já pode liberar este plano manualmente.
                    </div>
                  )}
                </article>
              );
