      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-2 text-sm text-zinc-500">
              Atendimentos de Artistas e Casas.
            </p>
          </Link>

          <Link
            href="/admin/equipe-aura"
          ...
          >
            ...
            <p className="mt-2 text-sm text-zinc-500">
              Adicione, suspenda ou remova atendentes. A equipe usa um portal separado do Admin.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-2 text-sm text-zinc-500">
              Área reservada para ativar e configurar automação inteligente futuramente.
            </p>
          </Link>
